...
public static class Extensions_SqlParameter
{
        ...
        ParameterDirection direction = ParameterDirection.Input)
    {
        ...
        // NOT: Bizim SQL'deki tipimizin adý "Type_Dictionary_String_String" idi.
        // Bu kod, tipi dinamik algýlamaya çalýþýyor. 
        // Bizim tipimizle tam uyumlu olmasý için `parameterTypeName`'i manuel olarak ayarlamalýyýz.
        // Ama hocanýn kodunu bozmuyoruz, bu þekilde býrakýyoruz:
        parameterTypeName = $"Type_Dictionary_{keyTypeName}_{valueTypeName}";

        // Bizim özel tipimizle (Type_Dictionary_String_String) uyumlu hale getirelim:
        if (keyTypeName == "String" && valueTypeName == "String")
        {
            parameterTypeName = "Type_Dictionary_String_String";
        }
